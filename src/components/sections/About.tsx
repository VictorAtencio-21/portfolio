...
export default function About() {
  return (
    <section className="w-full max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-3 gap-6">
      {/* Intro Card */}
      ...
      <div className="p-6 rounded-2xl shadow-md">
        ...
        <p className="text-zinc-400">
          I genuinely enjoy what I do. Coding isn’t just my job—it’s my favorite
          way to learn, create, and solve real problems. I’m constantly
          exploring new tech, pushing my limits, and building things that
          matter. I’m always on the lookout for new challenges and opportunities
          to grow.
        </p>
      </div>

      {/* Location Card */}
      <div className="p-6 rounded-2xl shadow-md flex flex-col justify-between">
        <div>
          <h2 className="text-white text-xl font-semibold mb-2">
            Remote & Flexible
          </h2>
